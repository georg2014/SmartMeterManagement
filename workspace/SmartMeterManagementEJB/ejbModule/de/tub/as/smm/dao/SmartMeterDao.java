...
public class SmartMeterDao {
	...
	/**
	 * 
	 * Updates the Ger�tekennung and the Max strain of a specific Smart Meter
	 * 
	 * @param gk Ger�tekennung of the SM that is to be updated
	 * @param newgk New Ger�tekennung
	...
	/**
	 * 
	 * Returns the SmartMeter that matches with the given Gr�tekennung
	 * 
	 * @param gk Ger�tekennung
	 * @return
	 */
